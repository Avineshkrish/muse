<?php function thb_clients_parent( $atts, $content = null ) {
	...
	<div id="<?php echo esc_attr($element_id); ?>" class="<?php echo implode(' ', $el_class); ?>">
		<div class="row no-padding <?php echo esc_attr($thb_style); ?>" data-columns="<?php echo esc_attr($thb_columns); ?>" data-center="true" data-navigation="true" data-autoplay="<?php echo esc_attr($autoplay); ?>" data-autoplay-speed="<?php echo esc_attr($autoplay_speed); ?>">
