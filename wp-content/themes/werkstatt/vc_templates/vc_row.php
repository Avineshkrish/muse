...
if ($thb_shape_divider == 'true') {
	...
	$output .= '<div id="thb-divider-id-'.esc_attr($divider_id).'" class="thb-divider-container '.esc_attr($divider_shape).'" style="height: '.esc_attr($thb_divider_height).'px;" data-position="'.esc_attr($thb_divider_position).'">'.$thb_divider_shape.'</div>';
	if ($thb_divider_color) {
		$output .= '<style>
			#thb-divider-id-'.esc_attr($divider_id).' .thb-svg-divider {
