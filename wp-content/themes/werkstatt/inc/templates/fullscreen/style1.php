...
<div class="swiper-container full-page style1 thb-portfolio <?php echo esc_attr($fs_footer); ?>" data-autoplay="<?php echo esc_attr($fs_autoplay); ?>" data-footer-style="<?php echo esc_attr($fs_footer); ?>">
   <div class="swiper-wrapper">
		...
		?>
			<div class="swiper-slide center-contents type-portfolio <?php echo esc_attr($main_color_title); ?>" data-color="<?php echo esc_attr($main_color_title); ?>" style="background-color:<?php echo esc_attr($main_color); ?>" id="portfolio-<?php echo esc_attr($id); ?>">
				<figure class="slider-inner <?php echo esc_attr($bg_position); ?>">
					...
					<a href="<?php echo esc_attr($permalink); ?>"></a>
				</figure>
			</div>
		<?php $i++; } } ?>
	</div>
