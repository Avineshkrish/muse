<?php 
	...
	// WP Remote Get Check
	$posting['wp_remote_get']['name'] = esc_html__( 'Remote Get', 'werkstatt');
...
<table class="widefat" cellspacing="0">
	<thead>
		...
		<?php if ( function_exists( 'ini_get' ) ) : ?>
			...
			<tr>
				<td data-export-label="PHP Time Limit"><?php esc_html_e( 'PHP Time Limit', 'werkstatt' ); ?>:</td>
				<td>
					<?php
					...
					<?php else: ?>
						<mark class="<?php echo esc_attr($mark); ?>">
								...
								<?php esc_html_e('The recommended value is 180.', 'werkstatt'); ?>
						</mark>
					<?php endif; ?>
		...
		<?php endif; ?>
		<tr>
			<td data-export-label="Max Upload Size"><?php esc_html_e( 'Max Upload Size', 'werkstatt' ); ?>:</td>
			<td>
				<?php
		...
		<?php
			...
			$posting['fsockopen_curl']['help'] = '<a href="#" class="help_tip" data-tip="' . esc_attr__( 'Payment gateways can use cURL to communicate with remote servers to authorize payments, other plugins may also use it when communicating with remote services.', 'werkstatt' ) . '">[?]</a>';
		...
		?>
		<tr>
			<td data-export-label="XML Reader"><?php esc_html_e( 'XML Reader', 'werkstatt' ); ?>:</td>
			<td>
				<?php
				...
				<?php if ($mark == 'yes'): ?>
					<mark class="<?php echo esc_attr($mark); ?>">
							<span class="dashicons dashicons-yes"></span> <?php esc_html_e('Installed' , 'werkstatt'); ?>
					</mark>
				<?php else: ?>
					<mark class="<?php echo esc_attr($mark); ?>">
							<span class="dashicons dashicons-warning"></span> 
							<?php esc_html_e('Please install XMLReader extension for your PHP.' , 'werkstatt'); ?>
					</mark>
				<?php endif; ?>
			</td>	
		</tr>
